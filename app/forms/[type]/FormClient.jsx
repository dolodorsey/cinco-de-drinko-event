...
const BRAND_KEY = 'cinco_de_mayo';
const BRAND = { name: 'Cinco De Drinko', bg: '#080604', accent: '#D4B87A', text: '#F5F0E8', font: "'Cormorant Garamond', serif" };
...
export default function FormClient({params}){
